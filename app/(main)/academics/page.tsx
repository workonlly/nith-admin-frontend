...
const sections: SectionItem[] = [
  {
    ...
    description: 'Undergraduate courses and curriculum',
    href: '/academics/bachelor',
    icon: GraduationCap,
  },
  {
    id: 2,
    title: 'Master Programmes',
    description: 'Postgraduate courses and curriculum',
  ...
  },
  {
    ...
    description: 'Enrollment and registration details',
  ...
  },
  {
    ...
    description: 'Exam schedules and evaluation criteria',
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-white/80 max-w-xl leading-relaxed">
              Manage academic programs, curriculum details, admissions, and exam schedules. Select a section below to begin editing.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm sticky top-6">
            ...
            <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100">
              Jump directly to any academic section to update course details or schedules.
            </p>

...
const sections: SectionItem[] = [
  {
    ...
    description: 'Manage faculty profiles and contact details',
  ...
  },
  {
    ...
    description: 'Manage faculty leaves and approvals',
    href: '/faculty/leaves',
    icon: CalendarOff,
  },
  {
    ...
    description: 'Manage faculty achievements and honors',
    href: '/faculty/awards',
    icon: Award,
  },
];
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-white/80 max-w-xl leading-relaxed">
              Manage faculty profiles, recruitment notices, leaves, and achievements. Select a section below to begin editing.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm sticky top-6">
            ...
            <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100">
              Jump directly to any section to update faculty details and records.
            </p>

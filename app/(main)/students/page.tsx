...
const sections: SectionItem[] = [
  ...
  },
  {
    id: 2,
    title: 'Hostels',
    description: 'Manage hostel accommodations and rules',
  ...
  },
  {
    ...
    description: 'Manage student clubs, societies and events',
  ...
  },
  {
    id: 4,
    title: 'Placements',
    description: 'Manage placement statistics and drives',
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-white/80 max-w-xl leading-relaxed">
              Manage student directories, hostel information, activities, and placements. Select a section below to begin editing.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm sticky top-6">
            ...
            <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100">
              Jump directly to any section to update student records and campus life details.
            </p>

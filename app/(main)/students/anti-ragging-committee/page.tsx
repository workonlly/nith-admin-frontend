...
import { Save, AlertTriangle, Plus, Trash2, FileText, Users, Link2 } from 'lucide-react';
...
export default function AntiRaggingCommitteePage() {
  ...
  const [data, setData] = useState<AntiRaggingData>({
    title_en: 'Anti Ragging Empowered Committee',
    title_hi: 'एंटी रैगिंग अधिकार प्राप्त समिति',
    description_en: '',
    description_hi: '',
    content: {
      overview_en: '',
  ...
  const fetchData = async () => {
    try {
      const res = await fetch('http://localhost:5000/api/v1/students?page_name=anti-ragging-committee');
      const json = await res.json();
      if (json.success && json.data) {
        const item = json.data;
        const content = item.content || {};
        setData({
          title_en: item.title_en || 'Anti Ragging Empowered Committee',
          title_hi: item.title_hi || 'एंटी रैगिंग अधिकार प्राप्त समिति',
      ...
      console.error('Error fetching anti-ragging data:', err);
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    try {
      const payload = {
        page_name: 'anti-ragging-committee',
  ...
  if (loading) {
    return <div className="p-8 text-black font-semibold text-center">Loading Anti Ragging Committee Editor...</div>;
  }
      ...
      <div className="bg-gradient-to-r from-[#631012] to-[#800000] rounded-2xl shadow-xl p-6 sm:p-8 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">Anti Ragging Committee</h1>
              <p className="text-white/80 text-sm sm:text-base mt-1">
                Manage bilingual anti-ragging committee compositions, descriptions, and contact settings.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 sm:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Anti Ragging Empowered Committee"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-[#631012] text-black"
                      placeholder="The Committee is responsible for..."
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-4 border-t md:border-t-0 md:border-l md:pl-6 pt-4 md:pt-0">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-[#631012] text-black"
                      placeholder="एंटी रैगिंग अधिकार प्राप्त समिति"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-[#631012] text-black"
                      placeholder="समिति संस्थान के नियमों..."
                    />
                  </div>
                  <div>
          ...
          {activeTab === 'composition' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b pb-3 mb-4">
                <h2 className="text-xl font-bold">Committee Composition</h2>
                <button
          ...
          {activeTab === 'contacts' && (
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Dean (Student Welfare) Email</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Faculty Incharge (Student Discipline) Email</label>
                  <input
                    type="email"

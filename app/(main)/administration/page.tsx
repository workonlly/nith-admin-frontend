...
const sections: SectionItem[] = [
  {
    id: 1,
    title: 'Chairperson',
    description: 'Board of Governors Chairman',
  ...
  },
  {
    id: 2,
    title: 'Director',
    description: 'Institute Director',
    href: '/administration/director',
    icon: User,
  },
  {
    id: 3,
    title: 'Deans & Assoc. Deans',
    description: 'Academic and administrative deans',
  ...
  },
  {
    ...
    href: '/administration/hod',
    icon: BookOpen,
  },
  {
    id: 5,
    title: 'Faculty Incharges',
    description: 'Faculty with special responsibilities',
  ...
  },
  {
    ...
    description: 'Officers for specific initiatives',
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-white/80 max-w-xl leading-relaxed">
              Manage administrative personnel, organizational hierarchy, and staff details. Select a section below to begin editing.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm sticky top-6">
            ...
            <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100">
              Jump directly to any administrative category to update roles and profiles.
            </p>
